...
#include "common.h"
...
#if defined(CONFIG_FIRMWARE_INCLUDE_QOS)
	struct variable variables_SqmConf[] = {
			{"sqm_enable", "", NULL, EVM_RESTART_FIREWALL},
			{"sqm_flag", "", NULL, EVM_RESTART_FIREWALL},
			{"sqm_active", "", NULL, EVM_RESTART_FIREWALL},
			{"sqm_qdisc", "", NULL, EVM_RESTART_FIREWALL},
			{"sqm_script", "", NULL, EVM_RESTART_FIREWALL},
			{"sqm_down_speed", "", NULL, EVM_RESTART_FIREWALL},
			{"sqm_up_speed", "", NULL, EVM_RESTART_FIREWALL},
			{"sqm_debug_log", "", NULL, EVM_RESTART_FIREWALL},
			{"sqm_log_level", "", NULL, EVM_RESTART_FIREWALL},
			{0,0,0,0}
		};
#endif
	...
	struct evDesc events_desc[] = {
		...
		{EVM_RESTART_TELNETD,		EVM_RESTART_TELNETD,		RCN_RESTART_TELNETD,	0},
...
#if defined(USE_USB_SUPPORT)
		{EVM_RESTART_SPOOLER,		EVM_RESTART_SPOOLER,		RCN_RESTART_SPOOLER,	0},
		{EVM_RESTART_HDDTUNE,		EVM_RESTART_HDDTUNE,		RCN_RESTART_HDDTUNE,	0},
#if defined(APP_FTPD)
		{EVM_RESTART_FTPD,		EVM_RESTART_FTPD,		RCN_RESTART_FTPD,	EVM_RESTART_FIREWALL},
#endif
#if defined(APP_SMBD)
		{EVM_RESTART_SMBD,		EVM_RESTART_SMBD,		RCN_RESTART_SMBD,	EVM_RESTART_NMBD},
#endif
#if defined(APP_NFSD)
		{EVM_RESTART_NFSD,		EVM_RESTART_NFSD,		RCN_RESTART_NFSD,	0},
#endif
#if defined(APP_MINIDLNA)
		{EVM_RESTART_DMS,		EVM_RESTART_DMS,		RCN_RESTART_DMS,	0},
#endif
#if defined(APP_FIREFLY)
		{EVM_RESTART_ITUNES,		EVM_RESTART_ITUNES,		RCN_RESTART_ITUNES,	0},
#endif
#if defined(APP_TRMD)
		{EVM_RESTART_TRMD,		EVM_RESTART_TRMD,		RCN_RESTART_TRMD,	EVM_RESTART_FIREWALL},
#endif
#if defined(APP_ARIA)
		{EVM_RESTART_ARIA,		EVM_RESTART_ARIA,		RCN_RESTART_ARIA,	EVM_RESTART_FIREWALL},
#endif
#endif
#if defined(APP_SCUT)
		{EVM_RESTART_SCUT,		EVM_RESTART_SCUT,		RCN_RESTART_SCUT,	0},
#endif
#if defined(APP_MENTOHUST)
		{EVM_RESTART_MENTOHUST,		EVM_RESTART_MENTOHUST,		RCN_RESTART_MENTOHUST,	0},
#endif
#if defined(APP_TTYD)
		{EVM_RESTART_TTYD,		EVM_RESTART_TTYD,		RCN_RESTART_TTYD,	0},
#endif
#if defined(APP_VLMCSD)
		{EVM_RESTART_VLMCSD,	EVM_RESTART_VLMCSD,		RCN_RESTART_VLMCSD,	0},
#endif
#if defined(APP_DNSFORWARDER)
		{EVM_RESTART_DNSFORWARDER,	EVM_RESTART_DNSFORWARDER,	RCN_RESTART_DNSFORWARDER, 0},
#endif
#if defined(APP_FRP)
		{EVM_RESTART_FRP,	EVM_RESTART_FRP,	RCN_RESTART_FRP, 0},
#endif
#if defined(APP_SHADOWSOCKS)
		{EVM_RESTART_SHADOWSOCKS,	EVM_RESTART_SHADOWSOCKS,	RCN_RESTART_SHADOWSOCKS,  0},
		{EVM_RESTART_SS_TUNNEL,		EVM_RESTART_SS_TUNNEL,		RCN_RESTART_SS_TUNNEL,	  0},
#endif
#if defined(APP_KOOLPROXY)
		{EVM_RESTART_KOOLPROXY,		EVM_RESTART_KOOLPROXY,		RCN_RESTART_KOOLPROXY,	0},
#endif
#if defined(APP_ADGUARDHOME)
...
#endif
#if defined(APP_WYY)
		{EVM_RESTART_WYY,		EVM_RESTART_WYY,		RCN_RESTART_WYY,	0},
#endif
#if defined(APP_ZEROTIER)
		{EVM_RESTART_ZEROTIER,		EVM_RESTART_ZEROTIER,		RCN_RESTART_ZEROTIER,	0},
#endif
#if defined(APP_ADBYBY)
		{EVM_RESTART_ADBYBY,		EVM_RESTART_ADBYBY,		RCN_RESTART_ADBYBY,	0},
#endif
#if defined(APP_SMARTDNS)
		{EVM_RESTART_SMARTDNS,		EVM_RESTART_SMARTDNS,		RCN_RESTART_SMARTDNS,	0},
#endif
#if defined(APP_ALIDDNS)
		{EVM_RESTART_ALIDDNS,		EVM_RESTART_ALIDDNS,		RCN_RESTART_ALIDDNS,	0},
#endif
#if defined(APP_NPC)
		{EVM_RESTART_NPC,		EVM_RESTART_NPC,		RCN_RESTART_NPC,	0},
#endif
#if defined(APP_SMBD) || defined(APP_NMBD)
		{EVM_RESTART_NMBD,		EVM_RESTART_NMBD,		RCN_RESTART_NMBD,	0},
#endif
