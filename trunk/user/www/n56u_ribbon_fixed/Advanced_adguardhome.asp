						...
						<div class="box well grad_colour_dark_blue">
							...
							<div class="round_bottom">
								<div class="row-fluid">
									...
									<p>AdGuard Home is a network-wide software for blocking ads and tracking. Once you set it up, it will cover ALL your home devices, and you do not need any client-side software. With the rise of IoT and connected devices, taking control of your entire network environment is becoming more and more important.
									</p>
									AdGuard Home Homepage: <a href="https://adguard.com/" target="blank"><i><u>https://adguard.com/</u></i></a>
									</div>
									...
									<table width="100%" align="center" cellpadding="4" cellspacing="0" class="table">
										<tr>
                                         ...
                                         <tr>
											...
											<td>
												<select name="adg_redirect" class="input" style="width: 250px">
													<option value="0" <% nvram_match_x("","adg_redirect", "0","selected"); %>>None</option>
													<option value="1" <% nvram_match_x("","adg_redirect", "1","selected"); %>>As upstream DNS server for dnsmasq</option>
										...
										<tr>
											...
											<td>
											<a href="http://<% nvram_get_x("", "lan_ipaddr"); %>:3030" target="_blank">http://<% nvram_get_x("", "lan_ipaddr"); %>:3030</a>
											</td>
										</tr>
